...
class TextboxIsNotEmptyAction(ActionBase):
    def __init__(self, browser_driver, language):
        super(TextboxIsNotEmptyAction, self).__init__(browser_driver, language)

    def matches(self, line):
        reg = self.language["textbox_is_not_empty_regex"]
    ...
    def execute(self, values, context):
        ...
        self.assert_element_is_not_empty(textbox, self.language["textbox_is_not_empty_failure"] % textbox_name)
