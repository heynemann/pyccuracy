...
class ImageDoesNotHaveSrcOfAction(ActionBase):
    def __init__(self, browser_driver, language):
        super(ImageDoesNotHaveSrcOfAction, self).__init__(browser_driver, language)

    def matches(self, line):
        reg = self.language["image_does_not_have_src_regex"]
    ...
    def execute(self, values, context):
        ...
        error_message = self.language["image_does_not_have_src_failure"]
