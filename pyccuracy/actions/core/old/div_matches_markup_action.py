...
class DivMatchesMarkupAction(ActionBase):
    def __init__(self, browser_driver, language):
        super(DivMatchesMarkupAction, self).__init__(browser_driver, language)

    def matches(self, line):
        reg = self.language["div_matches_markup_regex"]
    ...
    def execute(self, values, context):
        ...
        if (not current_markup) or (markup.lower() != current_markup.lower()):
            error_message = self.language["div_matches_markup_failure"]
