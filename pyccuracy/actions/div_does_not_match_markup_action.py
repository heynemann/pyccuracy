...
class DivDoesNotMatchMarkupAction(ActionBase):
    def __init__(self, browser_driver, language):
        super(DivDoesNotMatchMarkupAction, self).__init__(browser_driver, language)

    def matches(self, line):
        reg = self.language["div_does_not_match_markup_regex"]
    ...
    def execute(self, values, context):
        ...
        if markup.lower() == current_markup.lower():
            error_message = self.language["div_does_not_match_markup_failure"]
