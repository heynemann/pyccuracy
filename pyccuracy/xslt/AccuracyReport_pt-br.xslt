...
>
  ...
  <xsl:template match="/report/footer">
    <tr>
      <td class="footer">
        Pyccuracy - Versão <xsl:value-of select ="@version"/> - <a href="http://www.pyccuracy.org">http://www.pyccuracy.org</a>
      </td>
    </tr>
  </xsl:template>
</xsl:stylesheet>
